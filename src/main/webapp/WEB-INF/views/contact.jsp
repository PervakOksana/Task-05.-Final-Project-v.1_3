...
<!-- menu -->
	<ul id="menu">
		...
		<li><a
			href="Controller?command=localization&local=en&page=topaymaentcontactpage&take=not"><img
				src="images/eng.png" /></a></li>
		<li><a
			href="Controller?command=localization&local=ru&page=topaymaentcontactpage&take=not"><img
    ...
    <p align="left">
		<c:out value="${requestScope.applicationInfo.contact}" />
	</p>
