...
<!-- menu -->
	<ul id="menu">
		...
		<li><a
			href="Controller?command=localization&local=en&page=addnewcarview"><img
				src="images/eng.png" /></a></li>
		<li><a
			href="Controller?command=localization&local=ru&page=addnewcarview"><img
    ...
    <input type="hidden" name="command" value="addnewcar" /> 
      ...
      <input type="text" name="describe_of_brand" value="" maxlength="1000" required/>
      
      <label for="bodywork"><b>${bodywork}</b></label>
      <input type="text" name="bodywork" value="" required/>

      <label for="power"><b>${power}</b></label>
      <input type="text" name="power" value="" required/>
      
      <label for="transmission"><b>${transmission}</b></label>
      <input type="text" name="transmission" value="" required/>
      
      <label for="number_of_doors"><b>${number_doors}</b></label>
      <input type="text" name="number_of_doors" value="" required/>
      
      <label for="year"><b>${year}</b></label>
      <input type="text" name="year" value="" required/>
      
      <label for="photoPath"><b>${photo}</b></label>
      <input type="file" name="photoPath"value="" required/></br></br>
    ...
    <c:if test="${sessionScope.notice_number eq \"error_number\" }">
      ...
      <input type="text" name="cost_hour" value="" required/>
      
      <label for="cost_dayr"><b>${cost_day}</b></label>
      <input type="text" name="cost_dayr" value=""  required/>
      
      <label for="sale"><b>${sale}</b></label>
      <input type="text" name="sale" value="" required/>
